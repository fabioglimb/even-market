...
- **No API key required** — Yahoo Finance via hardened Cloudflare Worker proxy
...
Distribution is via the `.ehpk` package on the Even Hub. Scan the QR code in the Even Realities companion app:
